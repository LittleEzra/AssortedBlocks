...
public class ArtistryBlockLootTableProvider extends BlockLootSubProvider {
    ...
    protected void generate() {
        ...
        this.dropSelf(ArtistryBlocks.GLOWING_MUSHROOM.get());
        this.add(ArtistryBlocks.GLOWING_MUSHROOM_BLOCK.get(), block -> this.createMushroomBlockDrop(block, ArtistryBlocks.GLOWING_MUSHROOM));
        ...
        this.dropSelf(ArtistryBlocks.LETTER.get());
        ...
        this.dropSelf(ArtistryBlocks.AZURE_SMOOTH_CALCITE.get());
        this.dropSelf(ArtistryBlocks.AZURE_POLISHED_CALCITE.get());
        this.dropSelf(ArtistryBlocks.AZURE_CALCITE_BRICKS.get());
        this.dropSelf(ArtistryBlocks.AZURE_SMALL_CALCITE_BRICKS.get());
        this.dropSelf(ArtistryBlocks.SCARLET_SMOOTH_CALCITE.get());
        this.dropSelf(ArtistryBlocks.SCARLET_POLISHED_CALCITE.get());
        this.dropSelf(ArtistryBlocks.SCARLET_CALCITE_BRICKS.get());
        this.dropSelf(ArtistryBlocks.SCARLET_SMALL_CALCITE_BRICKS.get());
        this.dropSelf(ArtistryBlocks.VERDANT_SMOOTH_CALCITE.get());
        this.dropSelf(ArtistryBlocks.VERDANT_POLISHED_CALCITE.get());
        this.dropSelf(ArtistryBlocks.VERDANT_CALCITE_BRICKS.get());
        this.dropSelf(ArtistryBlocks.VERDANT_SMALL_CALCITE_BRICKS.get());
        this.dropSelf(ArtistryBlocks.ROSE_SMOOTH_CALCITE.get());
        this.dropSelf(ArtistryBlocks.ROSE_POLISHED_CALCITE.get());
        this.dropSelf(ArtistryBlocks.ROSE_CALCITE_BRICKS.get());
        this.dropSelf(ArtistryBlocks.ROSE_SMALL_CALCITE_BRICKS.get());
        this.dropSelf(ArtistryBlocks.SUNNY_SMOOTH_CALCITE.get());
        this.dropSelf(ArtistryBlocks.SUNNY_POLISHED_CALCITE.get());
        this.dropSelf(ArtistryBlocks.SUNNY_CALCITE_BRICKS.get());
        this.dropSelf(ArtistryBlocks.SUNNY_SMALL_CALCITE_BRICKS.get());
