    ...
    protected void addTags(HolderLookup.Provider provider) {
        ...
        this.tag(BlockTags.MINEABLE_WITH_PICKAXE)
                .add(
                        ...
                        AZURE_SMOOTH_CALCITE.get(),
                        AZURE_POLISHED_CALCITE.get(),
                        AZURE_CALCITE_BRICKS.get(),
                        AZURE_SMALL_CALCITE_BRICKS.get(),
                        SCARLET_SMOOTH_CALCITE.get(),
                        SCARLET_POLISHED_CALCITE.get(),
                        SCARLET_CALCITE_BRICKS.get(),
                        SCARLET_SMALL_CALCITE_BRICKS.get(),
                        VERDANT_SMOOTH_CALCITE.get(),
                        VERDANT_POLISHED_CALCITE.get(),
                        VERDANT_CALCITE_BRICKS.get(),
                        VERDANT_SMALL_CALCITE_BRICKS.get(),
                        ROSE_SMOOTH_CALCITE.get(),
                        ROSE_POLISHED_CALCITE.get(),
                        ROSE_CALCITE_BRICKS.get(),
                        ROSE_SMALL_CALCITE_BRICKS.get(),
                        SUNNY_SMOOTH_CALCITE.get(),
                        SUNNY_POLISHED_CALCITE.get(),
                        SUNNY_CALCITE_BRICKS.get(),
                        SUNNY_SMALL_CALCITE_BRICKS.get(),
