...
public class OldAspenFoliagePlacer extends FoliagePlacer {
    public static final MapCodec<OldAspenFoliagePlacer> CODEC = RecordCodecBuilder.mapCodec(aspenFoliagePlacerInstance
            ...
            .apply(aspenFoliagePlacerInstance, OldAspenFoliagePlacer::new));

    private final int height;
    private final IntProvider leavesHeight;

    public OldAspenFoliagePlacer(IntProvider pRadius, IntProvider pOffset, int height, IntProvider leavesHeight) {
